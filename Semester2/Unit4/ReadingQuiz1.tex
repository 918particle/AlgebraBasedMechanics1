...
\title{Wednesday Reading Assessment: Unit 4, Magnetic Induction}
...
\begin{enumerate}
\item Suppose a uniform B-field of 0.01 T made an angle of 45 degrees with an wire loop with an area of 0.1 m$^2$.  (a) Calculate $\phi_m$, the magnetic flux. (b) Suppose the B-field drops to 0 T in 10 ms.  What is $\Delta \phi_m / \Delta t$? \\ \vspace{3cm}
