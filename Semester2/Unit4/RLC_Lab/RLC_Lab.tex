...
30000 & \\ \hline
\end{tabular}
\caption{\label{tab:data} Perform the necessary measurements to complete this table, and add any frequencies that you can detect in between and above and below the frequencies given.}
\end{table}
