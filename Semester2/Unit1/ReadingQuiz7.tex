...
\item Consider Fig. \ref{fig:2}.  Let $V_1 = 12$ V, $V_2 = 1.2$ V, and all resistors have a value of $2$ k$\Omega$.  (a) Use the loop rule to show that
\begin{equation}
...
\item Solve for all currents through all resistors in Fig. \ref{fig:2}.
\end{enumerate}
