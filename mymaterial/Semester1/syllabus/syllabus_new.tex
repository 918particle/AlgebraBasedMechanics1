...
\textit{\textbf{Regular course hours and location}: Monday and Wednesday, SLC232, 8:50-10:50, predominantly synchronous time.} \\
...
\textit{\textbf{Homework and Reading}: OpenStax Tutor: \url{https://tutor.openstax.org/enroll/372180/College-Physics-Fall-2021}.} Homework sets will usually require 10 exercises per week, and is integrated with the open-access text from which reading assignments will be given. This system costs 10 dollars, but the textbook is free. \\
\textit{\textbf{Online Laboratories}: Some laboratory activities will be through \url{pivotinteractives.com}.  Instructions will be posted on Moodle for how to sign up.  There is no cost to the student.} \\
