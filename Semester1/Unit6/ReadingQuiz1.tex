...
\title{Wednesday Reading Assessment: Unit 4, Circular Motion}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.25\textwidth]{circle.jpeg}
\includegraphics[width=0.23\textwidth]{record.png}
...
\item What is the \textit{centripetal force} of the fly, if $m=1$ gm? \\ \vspace{2cm}
\item Using definitions in the Memory Bank, show that if $F_{\rm C} = m r \omega^2$, that
\begin{equation}
F_{\rm C} = \frac{mv^2}{r}
\end{equation}
\end{enumerate}
