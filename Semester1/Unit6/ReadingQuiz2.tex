...
\end{itemize}
\item Suppose the radius is 8 cm, and we measure $v = 15$ m/s.  (a) What is $\omega$?  (b) What is $a_C$?  If solid contents of the vial have a mass $m = 10$ grams, what is $F_{\rm C}$? \\ \vspace{3cm}
\item What is the rotational \textit{period} of the motion?  That is, how long does it take for $m$ to go around the circle? \\ \vspace{3cm}
\item The mass of the Moon is estimated to be $7.3 \times 10^{22}$ kg, and the mass of the Earth is $6.0 \times 10^{24}$ kg.  The Moon orbits the Earth at a distance of 384,000 km.  Assuming that the centripetal force is provided by Eq. \ref{eq:1}, solve for the orbital period of the moon.
\end{enumerate}
