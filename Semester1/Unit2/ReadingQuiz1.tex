...
\begin{enumerate}
\item A projectile is launched at ground level with an initial speed of 33.0 m s$^{-1}$ at an angle of 30.0 degrees above the horizontal (Fig. \ref{fig:1}). It strikes a target 3.00 seconds later.  Give the final x and y coordinates. \\ \vspace{3cm}
...
\begin{enumerate}
\item A man pushes a crate of mass 50 kg.  The observed acceleration is 0.5 m s$^{-2}$.  (a) What is the force by the man on the crate? (b) If the crate were 100 kg, what would be the acceleration?
\end{enumerate}
